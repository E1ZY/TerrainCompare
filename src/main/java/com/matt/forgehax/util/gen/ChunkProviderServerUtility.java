...
import com.matt.forgehax.util.gen.ChunkGeneratorOverworldUtility;
...
public class ChunkProviderServerUtility implements IChunkProvider
{
  ...
  public final WorldServerUtility world;
  private final Set<Long> loadingChunks = com.google.common.collect.Sets.newHashSet();

  public ChunkProviderServerUtility(WorldServerUtility worldObjIn, IChunkLoader chunkLoaderIn, IChunkGenerator chunkGeneratorIn)
  {
  ...
  /**
   * Marks the chunk for unload if the {@link} allows it.
   *
