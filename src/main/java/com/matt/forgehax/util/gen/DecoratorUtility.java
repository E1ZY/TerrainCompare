...
public class DecoratorUtility {
    ...
    public void decorate(Chunk chunk, Random random, Biome biome, BlockPos pos, World world)
    {
      if (this.decorating)
      {
      ...
      else
      {
        ...
        this.genDecorations(biome, chunk, random);
        this.decorating = false;
      }
    }

    protected void genDecorations(Biome biomeIn, Chunk chunk, Random random)
    {
      ...
      this.generateOres(chunk, random);

      if(net.minecraftforge.event.terraingen.TerrainGen.decorate(chunk, random, forgeChunkPos, net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.SAND))
