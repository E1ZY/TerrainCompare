...
public class WoodlandMansionUtility extends MapGenStructure
{
  ...
  public WoodlandMansionUtility(ChunkGeneratorOverworldUtility providerIn)
  {
  ...
  {
    return new WoodlandMansionUtility.Start(this.world, this.provider, this.rand, chunkX, chunkZ);
  }
