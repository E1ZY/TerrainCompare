...
public class WoodlandMansionUtility extends MapGenStructure {
    ...
    private final ChunkGeneratorOverworldUtility provider;

    public WoodlandMansionUtility(ChunkGeneratorOverworldUtility p_i47240_1_) {
    ...
    protected StructureStart getStructureStart(int p_75049_1_, int p_75049_2_) {
        return new WoodlandMansionUtility.Start(this.world, this.provider, this.rand, p_75049_1_, p_75049_2_);
    }
    ...
    public static class Start extends StructureStart {
        ...
        public Start(World p_i47235_1_, ChunkGeneratorOverworldUtility p_i47235_2_, Random p_i47235_3_, int p_i47235_4_, int p_i47235_5_) {
            super(p_i47235_4_, p_i47235_5_);
            this.create(p_i47235_1_, p_i47235_2_, p_i47235_3_, p_i47235_4_, p_i47235_5_);
        }

        private void create(World p_191092_1_, ChunkGeneratorOverworldUtility p_191092_2_, Random p_191092_3_, int p_191092_4_, int p_191092_5_) {
            ...
            if (lvt_14_1_ < 60) {
                ...
                List<MansionTemplate> lvt_16_1_ = Lists.newLinkedList();
