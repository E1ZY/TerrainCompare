...
public class WorldServerUtility extends World implements IThreadListener
{
  ...
  public WorldServerUtility(ISaveHandler saveHandlerIn, WorldInfo info, int dimensionId, Profiler profilerIn)
  {
  ...
  protected IChunkProvider createChunkProvider()
  {
    ...
    return new ChunkProviderServerUtility(this, ichunkloader, this.provider.createChunkGenerator());
  }
  ...
  {
    ChunkProviderServerUtility chunkproviderserver = this.getChunkProvider();
   ...
   */
  public ChunkProviderServerUtility getChunkProvider()
  {
    return (ChunkProviderServerUtility) super.getChunkProvider();
  }
