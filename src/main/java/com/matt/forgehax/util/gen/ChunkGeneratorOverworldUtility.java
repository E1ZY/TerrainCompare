...
import com.matt.forgehax.util.gen.WoodlandMansionUtility;
...
public class ChunkGeneratorOverworldUtility implements IChunkGenerator
{
  ...
  public ChunkGeneratorOverworldUtility(WorldServerUtility worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions)
  {
    {
      ...
      woodlandMansionGenerator = (WoodlandMansionUtility) net.minecraftforge.event.terraingen.TerrainGen.getModdedMapGen(woodlandMansionGenerator, net.minecraftforge.event.terraingen.InitMapGenEvent.EventType.WOODLAND_MANSION);
    }
    this.world = worldIn;
